...
public class GoToTheatre : Affordance {

	Vector3 pos;

	public GoToTheatre (SmartCharacter afdnt, SmartTheatreSeat afdee) {
	...
	public Node PBT(){
		...
		return (new Sequence(this.affordant.gameObject.GetComponent<BehaviorMecanim> ().Node_GoToUpToRadius (pos,2), this.UpdateAndPublish()));
	}
}
