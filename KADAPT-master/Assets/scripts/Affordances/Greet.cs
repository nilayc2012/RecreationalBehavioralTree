...
new Sequence(
                    new SequenceParallel(
                        new LeafInvoke(() => GameObject.Find("GameController").GetComponent<Behavior>().ActivateObject(affordant.gameObject.transform, "greet")),
                        affordant.gameObject.GetComponent<BehaviorMecanim>().Node_HandAnimation("reachright",true)),
                    new LeafWait(2000),
					new SequenceParallel(
                        new LeafInvoke(() => GameObject.Find("GameController").GetComponent<Behavior>().DeactivateObject(affordant.gameObject.transform, "greet")),
